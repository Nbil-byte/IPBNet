    ...
    <body>
        ...
        <section class="hero">
          <div class="hero-content">
            ...
            <?php if(Route::has('register')): ?><a href="<?php echo e(route('register')); ?>"class="btn">Get Started</a><?php endif; ?>
          </div>
        </section>
...
<?php /**PATH C:\laragon\www\IPBNet2.0\resources\views/welcome.blade.php ENDPATH**/ ?>